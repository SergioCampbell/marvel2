...
export const data: Characters = {
	"code": 200,
	"status": "Ok",
	"copyright": "© 2024 MARVEL",
	"attributionText": "Data provided by Marvel. © 2024 MARVEL",
	"attributionHTML": "<a href=\"http://marvel.com\">Data provided by Marvel. © 2024 MARVEL</a>",
	"etag": "6b4a2ef39c033077efb27a575b87ee7b32112500",
	"data": {
		"offset": 0,
		"limit": 10,
		"total": 1564,
		...
		"results": [
			{
				"id": 1011334,
				"name": "3-D Man testasdasdasdasdas",
				"description": "",
...
// Function to recursively set empty strings for all string properties
const setEmptyStrings = (obj: any) => {
	for (const key in obj) {
		if (typeof obj[key] === "string") {
			obj[key] = ""; // Set to empty string
		} else if (typeof obj[key] === "object") {
			setEmptyStrings(obj[key]); // Recursively traverse nested objects
		}
	}
};
...
// console.log(DEFAULT_VALUES.data.results);